...
const WelcomeMessage = `Chào bạn 👋 Mình là advisor bot — trợ lý scalping, mặc định vàng (XAUUSDT), M1 entry + M5 confirm.
...
Mặc định XAUUSDT; thêm BTCUSDT khi bạn nhắc rõ BTC. Timeframe: M1 (default scalping), M5, M15, H1, H4, D1.
Lệnh: /analyze, /reset (xoá ngữ cảnh), /help.

(Hi! Default XAUUSDT; say BTC/bitcoin explicitly for BTCUSDT. M1 scalping with M5/H1/H4 context.)`
